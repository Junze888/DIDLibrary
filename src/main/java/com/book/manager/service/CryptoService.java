...
public class CryptoService {
    ...
    public static SECPSignature Sign(KeyPair keyPair, Bytes32 hash){
        return CryptoService.secp256K1.sign(hash,keyPair);
    }

    public static boolean Verify(Bytes data, SECPSignature signature, SECPPublicKey pub){
        return CryptoService.secp256K1.verify(data, signature, pub);
    }
    ...
    public static void main(String[] args) {
        BigInteger bigInteger = new BigInteger("28397");
        System.out.println(CryptoService.publicPointFromPrivate(bigInteger).normalize());
    }
